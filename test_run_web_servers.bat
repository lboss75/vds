...
start build\app\vds_web_server\Debug\vds_web_server.exe server start -P !port! --root-folder C:\Users\v.malyshev\source\repos\vds\servers\%%i -ll trace -lm * --web C:\Users\v.malyshev\source\repos\vds\www 
set /A port +=1
)