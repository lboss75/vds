#ifndef __VDS_P2P_NETWORK_RAFT_START_ELECTION_H_
#define __VDS_P2P_NETWORK_RAFT_START_ELECTION_H_
...
namespace vds {
  namespace p2p_messages {
    ...
    public:
      static const uint8_t message_id = (uint8_t)p2p_message_id::raft_start_election;
...
#endif //__VDS_P2P_NETWORK_RAFT_START_ELECTION_H_
