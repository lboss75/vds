#ifndef __VDS_P2P_NETWORK_RAFT_APPEND_ENTRIES_ACT_H_
#define __VDS_P2P_NETWORK_RAFT_APPEND_ENTRIES_ACT_H_
...
namespace vds {
  namespace p2p_messages {
    class raft_append_entries_act {
    public:
      static const uint8_t message_id = (uint8_t) p2p_message_id::raft_append_entries_act;

      raft_append_entries_act(
...
#endif //__VDS_P2P_NETWORK_RAFT_APPEND_ENTRIES_ACT_H_
