...
namespace vds {
  ...
  public:
    ...
    std::shared_ptr<async_stream<std::shared_ptr<json_value>>> outgoing_stream() const { return this->outgoing_stream_; }
  ...
  private:
    ...
    std::shared_ptr<async_stream<std::shared_ptr<json_value>>> outgoing_stream_;
