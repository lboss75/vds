...
vds::async_task<> vds::file_manager::file_manager_service::prepare_to_stop(const vds::service_provider &sp) {
...
vds::async_task<> vds::file_manager_private::_file_manager_service::prepare_to_stop(const vds::service_provider &sp) {
