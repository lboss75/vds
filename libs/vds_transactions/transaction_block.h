...
namespace vds {
  namespace transactions {
    ...
    public:
      ...
      static void parse_block(const const_data_buffer &data, const_data_buffer &channel_id, uint64_t &order_no, guid &read_cert_id,
      ...
      static bool validate_block(const certificate &write_cert, const const_data_buffer &channel_id, uint64_t &order_no, const guid &read_cert_id,
