...
//namespace vds {
//
//  class http_form_part_parser : public stream_output_async<uint8_t> {
//  public:
//    http_form_part_parser(
//		const service_provider * sp,
//        const std::function<vds::async_task<vds::expected<std::shared_ptr<stream_output_async<uint8_t>>>>(const http_message &message)> &message_callback)
//    : sp_(sp), message_callback_(message_callback), state_(parse_state::HEADERS) {
//    }
//
...
//	std::function<vds::async_task<vds::expected<std::shared_ptr<stream_output_async<uint8_t>>>>(const http_message &message)> message_callback_;
//
...
//    std::shared_ptr<stream_output_async<uint8_t>> current_message_body_;
//
//
//
//    class message_body_reader : public stream_output_async<uint8_t> {
//    public:
//      message_body_reader(
