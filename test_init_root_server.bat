...
build\app\vds_background\Debug\vds_background.exe server root -l vadim@iv-soft.ru -p 123qwe --root-folder C:\Users\v.malyshev\source\repos\vds\servers\1 -ll trace -lm *